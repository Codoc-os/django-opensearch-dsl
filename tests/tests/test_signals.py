    ...
    def test_deleting_model_instance_triggers_unindex(self):
        with patch("django_opensearch_dsl.documents.bulk") as mock:
            ...
            create_action = {
                "_id": continent.pk,
                "_op_type": "index",
                "_source": {"countries": [], "id": continent.pk, "name": continent.name},
                "_index": "continent",
            }
            ...
            # processors.
            continent.pk = pk
            delete_action = {"_id": continent.pk, "_op_type": "delete", "_index": "continent", "_source": None}
    ...
    def test_creating_and_deleting_model_instance_triggers_related(self):
        with patch("django_opensearch_dsl.documents.bulk") as mock:
            ...
            update_continent_action = {
                ...
                "_op_type": "index",
                "_source": {
                    "countries": [{"id": 1, "name": "MyOwnCountry", "area": 100, "population": 100}],
                    "id": continent.pk,
                    "name": continent.name,
                },
                "_index": "continent",
            ...
            # processors.
            country.pk = pk
            delete_action = {"_id": country.pk, "_op_type": "delete", "_index": "country", "_source": None}
